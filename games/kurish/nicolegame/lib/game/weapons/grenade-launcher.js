...
WeaponGrenadeLauncher = Weapon.extend({
	...
	ammoIconImage: new ig.Image( 'media/grenade-icon.png' ),
	ammoIcon: null,
	...
	init: function( ammo ) {
		...
		this.ammoIcon = new tpf.HudTile( this.ammoIconImage, 0, 48, 48);
		//cant friggen move this ammoicon on hud!!!!!
		this.ammoIcon.setPosition( 49, this.height-this.ammoIcon.tileHeight-4 );
		this.shootSound.volume = 0.2;
		this.emptySound.volume = 0.2;
	},

	//this is function for when ammo is gone
	depleted: function() {
